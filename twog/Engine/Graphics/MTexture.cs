...
{
    /// <summary>
    /// MyEngine texture is a wrapper class that handles textures without any complex setups.
    /// </summary>
    public class MTexture
    {
...
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, -DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, origin - DrawOffset, scale, flip, 0);
        }
        ...
        public void Draw(Vector2 position, Vector2 origin, Color color, Vector2 scale, float rotation, Rectangle clip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, GetRelativeRect(clip), color, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, Center - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, Center - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawCentered(Vector2 position, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, Center - DrawOffset, scale, flip, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, Color.White, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color, float scale)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        }
        ...
        public void DrawJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            if (Texture.IsDisposed)
                throw new Exception("Texture2D Is Disposed");
#endif
            MyEngine.Draw.SpriteBatch.Draw(Texture, position, ClipRect, color, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, flip, 0);
        }
        ...
        public void DrawOutline(Vector2 position)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, -DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, origin - DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, origin - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale, float rotation)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, origin - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutline(Vector2 position, Vector2 origin, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, origin - DrawOffset, scale, flip, 0);
        ...
        public void DrawOutlineCentered(Vector2 position)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, Center - DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutlineCentered(Vector2 position, Color color, float scale)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, Center - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineCentered(Vector2 position, Color color, float scale, float rotation)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, Center - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineCentered(Vector2 position, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, Center - DrawOffset, scale, flip, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, 1f, SpriteEffects.None, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify, Color color, float scale)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, 0, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, SpriteEffects.None, 0);
        ...
        public void DrawOutlineJustified(Vector2 position, Vector2 justify, Color color, float scale, float rotation, SpriteEffects flip)
        {
            ...
            for (var i = -1; i <= 1; i++)
                for (var j = -1; j <= 1; j++)
                    if (i != 0 || j != 0)
                        MyEngine.Draw.SpriteBatch.Draw(Texture, position + new Vector2(i, j), ClipRect, Color.Black, rotation, new Vector2(Width * justify.X, Height * justify.Y) - DrawOffset, scale, flip, 0);
