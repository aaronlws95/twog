...
namespace MyEngine
{
    public class Hitbox : Collider
    {
        ...
        {
            return MyEngine.Collide.RectToPoint(AbsoluteLeft, AbsoluteTop, Width, Height, point);
        }
        ...
        {
            return MyEngine.Collide.RectToLine(AbsoluteLeft, AbsoluteTop, Width, Height, from, to);
        }
        ...
        {
            return MyEngine.Collide.RectToCircle(AbsoluteLeft, AbsoluteTop, Width, Height, circle.AbsolutePosition, circle.Radius);
        }
