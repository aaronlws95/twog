...
namespace MyEngine
{
    public class Circle : Collider
    {
        ...
        {
            return MyEngine.Collide.CircleToPoint(AbsolutePosition, Radius, point);
        }

        public override bool Collide(Rectangle rect)
        {
            return MyEngine.Collide.RectToCircle(rect, AbsolutePosition, Radius);
        }

        public override bool Collide(Vector2 from, Vector2 to)
        {
            return MyEngine.Collide.CircleToLine(AbsolutePosition, Radius, from, to);
        }
